...
/* declarations */
const Questionnaire = require(path.join(__dirname, 'questionnaire.model'));
...
router.get(PATH_LIST, function getQuestionnaires(request, response, next) {
  ...
  Questionnaire
    .get(options, function onGetQuestionnaires(error, results) {
 ...
 */
router
  .post(PATH_LIST, function postQuestionnaire(request, response, next) {

    // obtain request body
    const body = _.merge({}, request.body);

    Questionnaire
      .post(body, function onPostQuestionnaire(error, created) {
 ...
 */
router
  .get(PATH_SINGLE, function getQuestionnaire(request, response, next) {
    ...
    Questionnaire
      .getById(options, function onGetQuestionnaire(error, found) {
 ...
 */
router
  .patch(PATH_SINGLE, function patchQuestionnaire(request, response, next) {
    ...
    Questionnaire
      .patch(id, patches, function onPatchQuestionnaire(error, patched) {
 ...
 */
router
  .put(PATH_SINGLE, function putQuestionnaire(request, response, next) {
    ...
    Questionnaire
      .put(id, updates, function onPutQuestionnaire(error, updated) {
 ...
 */
router
  .delete(PATH_SINGLE, function deleteQuestionnaire(request, response, next) {

    // obtain questionnaire id
    const { id } = request.params;

    Questionnaire
      .del(id, function onDeleteQuestionnaire(error, deleted) {
